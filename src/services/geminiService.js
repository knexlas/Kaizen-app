...
Return ONLY valid JSON as an array of exactly 3 short executable next steps. Each step should be concrete, action-first, and realistic within 5-30 minutes. No markdown.`;
